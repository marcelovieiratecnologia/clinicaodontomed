...
class Profissionais(models.Model):
		...
		num_registro_classe = models.IntegerField(verbose_name='Reg Conselho da Classe (CRM/CRO/CORE...)', blank=True, null=True)
		especialidade = models.ManyToManyField('Especialidades', verbose_name='Especialidades', related_name='qry_especialidade')#, on_delete=models.CASCADE)
		uf = models.ForeignKey("Estados", verbose_name='UF', related_name='qry_estados', blank=True, null=True, on_delete=models.CASCADE)
		orgao_emissor = models.ForeignKey("OrgaoEmissor", verbose_name='Orgão Emissor', related_name='qry_orgao_emissor', blank=True, null=True,on_delete=models.CASCADE)
