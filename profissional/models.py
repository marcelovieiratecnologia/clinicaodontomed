...
class Cidades(models.Model):
		...
		def save(self, force_insert=False, force_update=False, using=None,update_fields=None):
				...
				super(Cidades, self).save_base(force_insert, force_update)
...
class OrgaoEmissor(models.Model):
		...
		def save(self, force_insert=False, force_update=False, using=None,update_fields=None):
				...
				super(OrgaoEmissor, self).save(force_update, force_insert)
...
class Especialidades(models.Model):
		...
		def save(self, force_insert=False, force_update=False, using=None, update_fields=None):
				...
				super(Especialidades, self).save(force_insert, force_update)
...
class Profissionais(models.Model):
		...
		cidades = models.ForeignKey('Cidades', verbose_name='cidade', null=True,on_delete=models.CASCADE)
		...
		especialidade = models.ManyToManyField('Especialidades',
																					 ...
																					 related_name='qry_profissionais')  # , on_delete=models.CASCADE)
